...
default['is_apaas_openshift_cookbook']['openshift_web_console_logout_url'] = node['is_apaas_openshift_cookbook']['openshift_master_logout_url'] ? node['is_apaas_openshift_cookbook']['openshift_master_logout_url'] : '""'
