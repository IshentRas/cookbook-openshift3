...
if is_certificate_server
  ...
  master_servers.each do |master_server|
    ...
    node['is_apaas_openshift_cookbook']['ng_openshift_master_certs'].grep(/\.(?:crt|kubeconfig)$/).uniq.each do |master_certificate|
    ...
    node['is_apaas_openshift_cookbook']['ng_openshift_master_certs'].grep(/\.(?:key)$/).uniq.each do |master_key|
    ...
    remote_file "#{node['is_apaas_openshift_cookbook']['master_generated_certs_dir']}/openshift-#{master_server['fqdn']}/ca.serial.txt" do
      source "file://#{node['is_apaas_openshift_cookbook']['master_certs_generated_certs_dir']}/ca.serial.txt"
      not_if { ::File.file?("#{node['is_apaas_openshift_cookbook']['master_generated_certs_dir']}/openshift-#{master_server['fqdn']}/ca.serial.txt") }
      sensitive true
    end
