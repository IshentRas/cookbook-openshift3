...
if is_certificate_server
  ...
  include_recipe 'is_apaas_openshift_cookbook::etcd_recovery' if ::File.file?(node['is_apaas_openshift_cookbook']['adhoc_recovery_etcd_certificate_server']) || ::File.file?(node['is_apaas_openshift_cookbook']['adhoc_clean_etcd_flag'])
